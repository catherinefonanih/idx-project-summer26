...
sold05 = pd.read_csv('idx_files/CRMLSSold202405_filled.csv')
sold06 = pd.read_csv('idx_files/CRMLSSold202406_filled.csv')
sold07 = pd.read_csv('idx_files/CRMLSSold202407_filled.csv')
...
sold13 = pd.read_csv('idx_files/CRMLSSold202501_filled.csv')
